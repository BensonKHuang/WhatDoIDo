...
<body>
    ...
    <div id="container">
        ...
        <%
            RecommendationIterator rec = (RecommendationIterator) request.getAttribute("rec");
        ...
        %>
            ...
            <h3 id="location" class="highlight">
                <span><span><%= f.getLocation()%></span></span>
            </h3>

        <% } else{ %>
            <h1 class="highlight"><span><span>Try Again later.</span></span></h1>
        <% } %>
